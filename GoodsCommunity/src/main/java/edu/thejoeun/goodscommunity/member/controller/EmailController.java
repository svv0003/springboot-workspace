...
import edu.thejoeun.goodscommunity.member.model.service.EmailService;
...
public class EmailController {
    ...
    /**
     * 입력된 인증번호와 Session 에 저장되어있는 인증번호 비교
     * @param map 전달 받은 JSON에 -> Map 형태로 변경해서 저장
    ...
    public int checkAuthKey(@RequestBody Map<String, Object> map){
        ...
        // 이메일 있고, 인증번호 일치 == 1 일치하지 않으면 0 이 나올것
